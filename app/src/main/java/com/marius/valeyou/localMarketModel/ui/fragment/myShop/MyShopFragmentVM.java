...
public class MyShopFragmentVM extends BaseFragmentViewModel {
    ...
    @Inject
    public MyShopFragmentVM(SharedPref sharedPref, NetworkErrorHandler networkErrorHandler, LiveLocationDetecter liveLocationDetecter, WelcomeRepo welcomeRepo) {
