...
public class ProfileFragmentVM extends BaseFragmentViewModel {
    ...
    @Inject
    public ProfileFragmentVM(SharedPref sharedPref, NetworkErrorHandler networkErrorHandler, LiveLocationDetecter liveLocationDetecter, WelcomeRepo welcomeRepo) {
