...
public class MessagingActivityVM extends BaseActivityViewModel {
    ...
    @Inject
    public MessagingActivityVM(SharedPref sharedPref, NetworkErrorHandler networkErrorHandler, LiveLocationDetecter liveLocationDetecter, WelcomeRepo welcomeRepo) {
