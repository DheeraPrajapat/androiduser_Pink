...
public class SettingFragmentVM extends BaseFragmentViewModel {
    ...
    @Inject
    public SettingFragmentVM(SharedPref sharedPref, NetworkErrorHandler networkErrorHandler, LiveLocationDetecter liveLocationDetecter, WelcomeRepo welcomeRepo) {
