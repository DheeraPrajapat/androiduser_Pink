package com.marius.valeyou.localMarketModel.ui.activity.editProfile;
...
import com.marius.valeyou.databinding.ActivityEditProfile2Binding;
...
public class EditProfile2Activity extends AppActivity<ActivityEditProfile2Binding, EditProfileActivityVM> {
    ...
    protected BindingActivity<EditProfileActivityVM> getBindingActivity() {
        return new BindingActivity<>(R.layout.activity_edit_profile2, EditProfileActivityVM.class);
    }
        ...
        vm.base_click.observe(this, new Observer<View>() {
            ...
            public void onChanged(View view) {
                switch (view != null ? view.getId() : 0) {
                    ...
                    case R.id.etMonth:
                        MonthPickerDialog.Builder builder = new MonthPickerDialog.Builder(EditProfile2Activity.this,
                    ...
                    case R.id.etYear:
                        MonthPickerDialog.Builder builder1 = new MonthPickerDialog.Builder(EditProfile2Activity.this,
                                new MonthPickerDialog.OnDateSetListener() {
                                    @Override
                                    public void onDateSet(int selectedMonth, int selectedYear) {
    ...
    private void AllowLocationPermision() {
        Permissions.check(this, Manifest.permission.ACCESS_FINE_LOCATION, 0, new PermissionHandler() {
            ...
            public void onGranted() {
                ...
                Intent intent = new Intent(EditProfile2Activity.this, LocationActivity.class);
