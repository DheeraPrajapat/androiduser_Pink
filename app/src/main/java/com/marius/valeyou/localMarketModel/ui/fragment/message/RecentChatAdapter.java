...
public class RecentChatAdapter extends RecyclerView.Adapter<RecentChatAdapter.MyViewHolder> implements Filterable {
    Context context;
    ...
    public RecentChatAdapter(Context context, List<UsersModel> usersModelList, Listner listner){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecentChatAdapter.MyViewHolder(holderChatListBinding);
    }
