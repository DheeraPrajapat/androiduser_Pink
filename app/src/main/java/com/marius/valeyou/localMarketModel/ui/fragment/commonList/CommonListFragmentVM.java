...
public class CommonListFragmentVM extends BaseFragmentViewModel {
    ...
    @Inject
    public CommonListFragmentVM(SharedPref sharedPref, NetworkErrorHandler networkErrorHandler, LiveLocationDetecter liveLocationDetecter, WelcomeRepo welcomeRepo) {
