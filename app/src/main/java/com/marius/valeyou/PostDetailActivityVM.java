...
public class PostDetailActivityVM extends BaseActivityViewModel {
    public final SharedPref sharedPref;
    private final NetworkErrorHandler networkErrorHandler;
    public final LiveLocationDetecter liveLocationDetecter;
    private final WelcomeRepo welcomeRepo;

    SingleRequestEvent<SimpleApiResponse> addFavouriteEvent = new SingleRequestEvent<>();
    SingleRequestEvent<SimpleApiResponse> deletePostEvent = new SingleRequestEvent<>();

    @Inject
    public PostDetailActivityVM(SharedPref sharedPref, NetworkErrorHandler networkErrorHandler, LiveLocationDetecter liveLocationDetecter, WelcomeRepo welcomeRepo) {
