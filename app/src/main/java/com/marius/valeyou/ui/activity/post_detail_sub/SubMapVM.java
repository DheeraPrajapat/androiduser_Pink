...
public class SubMapVM extends BaseActivityViewModel {
    public SharedPref sharedPref;
    private NetworkErrorHandler networkErrorHandler;
    public LiveLocationDetecter liveLocationDetecter;
    private WelcomeRepo welcomeRepo;
    final SingleRequestEvent<MarketHomeModel> homeModelEvent = new SingleRequestEvent<>();


    @Inject
    public SubMapVM(SharedPref sharedPref, NetworkErrorHandler networkErrorHandler, LiveLocationDetecter liveLocationDetecter, WelcomeRepo welcomeRepo) {
