...
public class WhenTypeActivityVM extends BaseActivityViewModel {
    ...
    @Inject
    public WhenTypeActivityVM(SharedPref sharedPref, NetworkErrorHandler networkErrorHandler, LiveLocationDetecter liveLocationDetecter,WelcomeRepo welcomeRepo) {
