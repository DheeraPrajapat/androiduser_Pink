package com.marius.valeyou.util.misc;
...
public class BackStackManager {
    ...
    public void addReplaceFragments(int containerId, String tag, Fragment fragment, boolean shouldAnimate) {
    ...
    public void addReplaceSubFragments(int containerId, String tag, Fragment fragment, boolean shouldAnimate) {
    ...
    public void removeBackStack() {
        if (fragmentChangeListioner != null) {
            fragmentChangeListioner.onFragmentReplace("currentTab", manager.getBackStackEntryCount() > 0);
        }
    }
