...
public class Sub_cate_adp extends RecyclerView.Adapter<Sub_cate_adp.ViewHolder> {
    ...
    public Sub_cate_adp(List<Sub_cate_Get_Set> Cate_Arr, Context context, onclick itemclick ) {
