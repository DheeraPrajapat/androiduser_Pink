package com.marius.valeyou.market_place.Chat_pkg.Fragments;
...
public class See_Full_Image_F extends Fragment {
    ...
    File fullpath;
    int width,height;
    RelativeLayout RL_cloase_layout;

    public See_Full_Image_F() {
        // Required empty public constructor
    }

    // Note: ==>  Call this method at the end of onCreate Method.
    public void Change_dynamic_color () {
        // Method to change Dynamic color:
        try{
            ...
            RL_cloase_layout = view.findViewById(R.id.RL_cloase_layout);
            RL_cloase_layout.setBackground(Methods.getColorScala());
